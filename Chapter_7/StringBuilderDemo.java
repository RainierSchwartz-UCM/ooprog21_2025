public class StringBuilderDemo {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("(StringBuilder 1) nameString: " + nameString.toString());
      System.out.println("Capacity of nameString is: " + nameString.capacity());
      
      System.out.println("(StringBuilder 2) adressString: " + addressString.toString());
      System.out.println("Capacity of addressString is: " + addressString.capacity());
      
      nameString.setLength(20);
      addressString.setLength(20);
      
      System.out.println("(Length set to 20 for StringBuilder): The name is " + nameString + "end");
      System.out.println("(Length set to 20 for StringBuilder): The name is " + addressString);
   }
}